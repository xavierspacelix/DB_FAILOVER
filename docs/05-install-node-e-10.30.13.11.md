...
- File config: `patroni-node-e-10.30.13.11.yml`
...
cp /root/patroni-node-e-10.30.13.11.yml /etc/patroni/patroni.yml
```
...
restapi:
    listen: 10.30.13.11:8008
    connect_address: 10.30.13.11:8008
...
postgresql:
    listen: 10.30.13.11:5432
    connect_address: 10.30.13.11:5432
